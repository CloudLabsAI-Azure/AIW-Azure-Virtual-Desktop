# Exercise 8: Create a master image for AVD [Optional]
...
2. The AVD dashboard will launch, then click on the tile named **Session Desktop** under workspace **AVD-WS-02** to launch the desktop.
